...
#setwd('~/projects/adriana_paper/monocle/mouse/P11')
setwd('/krummellab/data1/arrao/projects/adriana_paper/monocle/mouse/P11')
...
cluster_mapping <- read.table('P11_clusters.tsv', sep="\t", row.names=1, header=TRUE)
sample_name <- 'P11'
