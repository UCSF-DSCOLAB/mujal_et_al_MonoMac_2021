...
#setwd('~/projects/adriana_paper/monocle/mouse/P1')
setwd('/krummellab/data1/arrao/projects/adriana_paper/monocle/mouse/P1')

########################################
#  From Adriana
#  Cluster 0 - H2-Ab1+ Mono 
#  Cluster 1 - IFN-responsive
#  Cluster 2 - Arg1+
#  Cluster 3 - Ms4a7+ TAM
#  Cluster 5 - Ly6c2+ Hp+ mono
#
# cluster_mapping <- data.frame(
#   rbind(
#     c(0,   "Ly6c+ H2-Ab+ Mono", 'deeppink2'),
#     c(1,   "Ifn-responsive",    'dark blue'),
#     c(2,   "Arg1+",             'orange1'),
#     c(3,   "Ms4a7+ TAM",        'deeppink4'),
#     c(5,   "Ly6c+ Hp+ Mono",    'lightpink2'),
#     c(999, "Rest",              'black')
#   ),
#   row.names = "X1"
# )
#
#colnames(cluster_mapping) <- c('P1', 'colors')
########################################
...
# One Off
#plot_cell_trajectory(data$HSMM, markers = c('H2-Ab1', 'Fcgr1', 'Fcgr3', 'Fcgr4'), use_color_gradient = TRUE, show_branch_points=F, cell_size=0.5)
#ggsave(file=paste(sample_name, num_top_to_use, "h2ab_fcgr134.png", sep="_"))